...
void PoolBuffer::Init(const unsigned short bufferPoolCount, std::shared_ptr<boost::asio::io_service::strand> pWorkerStrand)
{
...
void PoolBuffer::WriteData(std::shared_ptr<AsioSection> pSection, const char* pBuffer, unsigned short size)
{
